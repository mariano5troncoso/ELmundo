        ...
        <div className="bg-white p-4 rounded flex flex-col items-center" style={{ width: '500px', height: '500px' }}>
          ...
          {modalProduct && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700"><strong>Equivalencias:</strong> {modalProduct.THOMPSON} - {modalProduct.NAKATA} - {modalProduct.MONROE} - {modalProduct.AXIOS} - {modalProduct.TIPER}</p>
            </div>
          )}
        </div>
      </Modal>
