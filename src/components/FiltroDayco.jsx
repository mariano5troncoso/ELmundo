...
export default function FiltroDayco() {
        ...
        <div>
            ...
            >
                <div className="bg-white p-4 rounded flex flex-col items-center" style={{ width: '500px', height: '500px' }}>
                    <button onClick={closeModal} className="mb-4 bg-red-500 text-white px-4 py-2 rounded">
                        Cerrar
                    </button>
                    <Zoom>
                        <img src={modalImage} alt="Imagen ampliada" className="object-contain h-full w-full" />
                    </Zoom>
                </div>
            </Modal>
        </div>
